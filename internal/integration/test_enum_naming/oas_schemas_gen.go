...
func (PascalSpecialStrat) AllValues() []PascalSpecialStrat { _ = "STUB: not implemented"; return nil }
...
func (PascalStrat) AllValues() []PascalStrat { _ = "STUB: not implemented"; return nil }

// MarshalText implements encoding.TextMarshaler.
func (s PascalStrat) MarshalText() ([]byte, error) { _ = "STUB: not implemented"; return nil, nil }

// UnmarshalText implements encoding.TextUnmarshaler.
func (s *PascalStrat) UnmarshalText(data []byte) error { _ = "STUB: not implemented"; return nil }
...
func (s *ProbeLivenessOK) GetPascalExceptionStrat() PascalExceptionStrat {
	_ = "STUB: not implemented"
	return *new(PascalExceptionStrat)
}

// SetVeryBadEnum sets the value of VeryBadEnum.
func (s *ProbeLivenessOK) SetVeryBadEnum(val VeryBadEnum) { _ = "STUB: not implemented"; return }

// SetPascalStrat sets the value of PascalStrat.
func (s *ProbeLivenessOK) SetPascalStrat(val PascalStrat) { _ = "STUB: not implemented"; return }
...
func (VeryBadEnum) AllValues() []VeryBadEnum { _ = "STUB: not implemented"; return nil }

// MarshalText implements encoding.TextMarshaler.
func (s VeryBadEnum) MarshalText() ([]byte, error) { _ = "STUB: not implemented"; return nil, nil }

// UnmarshalText implements encoding.TextUnmarshaler.
func (s *VeryBadEnum) UnmarshalText(data []byte) error { _ = "STUB: not implemented"; return nil }
